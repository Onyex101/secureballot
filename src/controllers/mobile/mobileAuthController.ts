 ...
 */
export const mobileLogin = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const verifyDevice = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
